...
public class WifiDirectPluginScript : MonoBehaviour
{
    ...
    private Toggle discoverServicesButton;

    [SerializeField]
    [Tooltip("Action Button used to initiate WiFi Direct Service Hosting")]
    private Toggle hostServiceButton;
    ...
    public void DisplayConnectedDevices(string devices)
    {
        ...
        for (int i = 0; i < deviceList.Length; i++)
        {
            if (deviceList[i] != "")
            {
                serviceButtonList.text = $"{serviceButtonList.text},\n {deviceList[i]}";
            }
        }
    ...
    public void DisplayConnectedServiceFriendlyName(string serviceFriendlyName)
    {
        ...
        //         discoverServicesButton.isOn = false;
        //         servicesAvailableLabel.text = "";
    ...
    public void DisplayAvailableServices(string services)
    {
        ...
        for (int i = 0; i < serviceList.Length; i++)
        {
            if (serviceList[i] != "")
            {
                deviceButtonList.text = $"{deviceButtonList.text}, \n {serviceList[i]}";
            }
        }
