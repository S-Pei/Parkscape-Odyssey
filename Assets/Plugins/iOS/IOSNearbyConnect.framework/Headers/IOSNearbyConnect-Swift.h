...
#ifndef IOSNEARBYCONNECT_SWIFT_H
#define IOSNEARBYCONNECT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IOSNearbyConnect",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_EXTERN void modelStartDiscovery(void);


SWIFT_EXTERN void modelStopAdvertising(void);


SWIFT_EXTERN void modelStopDiscovery(void);
